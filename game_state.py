...
class Game_state:
    ...
    def __init__(self):
        ...
        # we create the two players for the game and give them randomized cards
        self.blue_player = Player(all_cards.deck.pop(), all_cards.deck.pop(), "blue", self)
        self.red_player = Player(all_cards.deck.pop(), all_cards.deck.pop(), "red", self)

        # draw the 5th card that will determine the first player
        fifth_card = all_cards.deck.pop()
